...
```shell
openfls --sonar_type log_replayer --shm_url arpa_overlay_shm --input_file /home/nanderson/projects/opt/logs/raw_openfls/20220719_raw_openfls_1658254286
```
...
#### Take log args:
```bash
--log_channel OPENFLS_RADAR_STAT --log_channel RADAR_NAV_SOLUTION --log_channel OPENINS_NAV_SOLUTION --log_directory=/home/gss/gss_logs/raw_openfls --start_logging --tx_at_startup --sonar_type=navnet_radar --local_nic_ip_addr=172.31.0.9 --skipped_scanlines=15 --stream_url=none --shm_url=arpa_overlay_shm --cmd_channel=OPENFLS_RADAR_CMD --status_channel=OPENFLS_RADAR_STAT --nav_solution_sub_channel=RADAR_NAV_SOLUTION --arpa_contacts_channel=OPENFLS_ARPA_CONTACTS --pub_indv_arpa --indv_arpa_contacts_channel=OPENFLS_INDV_ARPA_CONTACTS --logging_level=Severe
```

#### Replay log args:
```bash
sudo openfls --sonar_type log_replayer --shm_url arpa_overlay_shm --input_file /home/gss/gss_logs/raw_openfls/20241030T140010_sonar_log
```
## [[Plugins|Plugins]]
