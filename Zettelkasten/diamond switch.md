...
When mucking around with these settings, it could make the IP of the Diamond switch change. Run `sudo arp-scan -localnet` to find the switches IP. Should look like:
```bash
10.100.100.25	00:06:d5:e2:6f:b1	Diamond Systems Corp.
```
