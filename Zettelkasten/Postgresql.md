...
If you know that a Postgres instance is running and want to see where, you can use:
```bash
sudo -u postgres psql -c "select * from pg_settings where name = 'port'"
```
...
[See also this](https://www.crunchydata.com/blog/postgres-postmaster-file-explained#so-what-does-postmasterpid-do)
